            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="mb-0 text-lg leading-normal">
                        {{ $showEditModal ? 'Sửa Tác Giả' : 'Thêm Mới Tác Giả' }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form wire:submit.prevent="{{ $showEditModal ? 'editAuthor' : 'addNewAuthor' }}">
                        @csrf
                        <div class="card-body">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button wire:click.prevent="deleteAuthor" type="button" class="btn btn-danger">Xóa</button>
                </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="d-flex justify-content-between mb-2">
                <button wire:click="showFormAddNewAuthor" class="btn btn-primary"> <i class="fa fa-plus-circle"
                        aria-hidden="true"></i> Thêm Mới Tác Giả
                </button>
                <div class="d-flex">
                    <input wire:model="searchText" type="text" class="form-control float-right" placeholder="Search">
                </div>
                                ...
                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="example2"
                                                ...
                                                aria-sort="ascending">Tên tác giả</th>
                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                                colspan="1"
                                    ...
                                    <tbody wire:loading.remove wire:target="searchText">
                                        @forelse ($authors as $author)
                                            <tr class="odd">
                                                <td class="dtr-control" tabindex="0">{{ $author->id }}</td>
                                                ...
                                                <td class="project-actions text-center">
                                                    ...
                                                    <a wire:click.prevent="showFormEdit({{ $author->id }})"
                                                        class="btn btn-info btn-sm" href="#">
                                                        <i class="fas fa-pencil-alt">
                                                        </i>
                                                        Edit
                                                    </a>
                                                    <a wire:click.prevent="showDeleteModal({{ $author->id }})"
